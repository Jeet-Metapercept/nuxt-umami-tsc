    ...
    <Popover v-model:open="open">
      <PopoverTrigger as-child>
        ...
        >
          ...
          {{ selectedTeam.label }}
          <Icon name="carbon:chevron-sort" class="ml-auto h-4 w-4 shrink-0 opacity-50" />
        </Button>
      </PopoverTrigger>
      <PopoverContent class="w-[200px] p-0">
        <Command :filter-function="(list, term) => list.filter(i => i?.toLowerCase()?.includes(term)) ">
          <CommandList>
          ...
          <CommandList>
            <CommandGroup>
              <DialogTrigger as-child>
                ...
                >
                  <Icon name="ep:circle-plus" class="mr-2 h-5 w-5" />
                  Create Team
                </CommandItem>
              </DialogTrigger>
            </CommandGroup>
